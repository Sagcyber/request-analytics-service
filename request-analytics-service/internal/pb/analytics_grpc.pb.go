...
func (c *analyticsServiceClient) LogEvent(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*EventResponse, error) {
...
func (UnimplementedAnalyticsServiceServer) LogEvent(context.Context, *EventRequest) (*EventResponse, error) {
...
func _AnalyticsService_LogEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServiceServer).LogEvent(ctx, req.(*EventRequest))
	}
